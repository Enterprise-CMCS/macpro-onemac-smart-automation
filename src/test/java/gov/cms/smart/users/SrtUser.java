...
public class SrtUser {
    ...
    public HomePage loginWithSharedSecret() {
        ...
        return PageFactory.getLoginPage(driver, utils).loginWithSharedSecret(username, sharedSecret, password);
    }

    public void goToSpasWaiversPage() throws InterruptedException {
